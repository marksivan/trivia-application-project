...
public class RegisterPage extends JPanel {
    ...
    private void initializeComponents() {
        ...
        passwordField.setFont(new Font("Helvetica", Font.PLAIN, 14));
        gbc.gridx = 1;
        ...
        confirmPasswordField.setFont(new Font("Helvetica", Font.PLAIN, 14));
        gbc.gridx = 1;
        ...
        errorLabel.setFont(new Font("Helvetica", Font.PLAIN, 12));
        gbc.gridy = 5;
